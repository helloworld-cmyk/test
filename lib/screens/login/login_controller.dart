...
class LoginController {
	final ValueNotifier<LoginState> notifier;
	LoginState get state => notifier.value;
	set state(LoginState value) => notifier.value = value;

	static final RegExp _emailRegex = RegExp(r'^[^@\s]+@[^@\s]+\.[^@\s]+$');

	LoginController() : notifier = ValueNotifier(const LoginState());
